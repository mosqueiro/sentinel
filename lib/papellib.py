...
def is_valid_papel_address(address, network='mainnet'):
    ...
    papel_version = 140 if network == 'testnet' else 76
    ...
    try:
        ...
        # rescue from exception, not a valid Papel address
        return False

    if (address_version != papel_version):
        return False
